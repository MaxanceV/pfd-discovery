...
Ce projet porte sur la découverte de **dépendances fonctionnelles basées sur des motifs (Pattern Functional Dependencies - PFDs)** pour l'amélioration de la qualité des données. L'objectif est de comparer une approche algorithmique classique avec une approche assistée par une **IA agentique**.
...
## Technologies
* **Langage :** Python
* **IA :** Utilisation de LLMs (Mistral, Claude, etc.) pour la partie agentique.

---
*Projet réalisé dans le cadre du cours de Khalid Belhajjame — Université Paris Dauphine - PSL*.
